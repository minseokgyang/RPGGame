...
class MonsterBook:
    monsters = dict(
        _1막 = dict(
            ...
            _3 = Monster('홉고블린', 30, 0, 500),
            _4 = Monster('고블린_샤먼', 40, 0, 1000),
            _5 = Monster('고블린_챔피언', 50, 2, 600),
            _최종장 = Monster('고블린_로드', 80, 2, 10000),
        ),
        _2막 = dict()
    )
...
#
def monster_spown1_최종장():
    A = MonsterBook 
    B = A.monsters['_1막']['_최종장'] 
    return B
